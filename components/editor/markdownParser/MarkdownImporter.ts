...
export default class MarkdownImporter {
  ...
  static get toolbox() {
    return {
      ...
      icon: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgb(112, 118, 132)" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-fileUpload"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>',
    };
  }
  ...
  render() {
    ...
    doc.setAttribute('onload', JSON.stringify(this.parseMarkdown()));
    ...
    if (fileUpload) {
      fileUpload.onchange = (e: any) => {
        ...
        reader.onload = (readerEvent: any) => {
          ...
          (parsedMarkdown.data as any)?.children.forEach(
