import { extendVariants, Autocomplete as HAutocomplete, AutocompleteItem as HAutocompleteItem } from "@heroui/react";
  ...
  variants: {
    autocomplete: {
      default: {
        ...
        inputWrapper: "bg-white/[0.05] border border-white/[0.1] rounded-md p-1",
